...
class MyHomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Center(child: Text('My home page', style: TextStyle(color: Colors.white),)),
        ...
        children:  [
          ...
          TextField(
            ...
            onChanged: (val) {
              ...
              final ostatok = double.parse(_credAmountCtrl.text) - double.parse(_firstFondCtrl.text);
              if (monthCount <= 0) {
                _everyMonthFondCtrl.text = '';
                return;
              }
      ...
      floatingActionButton: FloatingActionButton(onPressed: () => print('the button is pressed'),),
    );
  }
}